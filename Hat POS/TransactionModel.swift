    ...
    func parseJson(_ data:Data){
        ...
        let jsonArray = try JSONSerialization.jsonObject(with: data, options: []) as! [Any]
            ...
            for jsonResult in jsonArray {
                ...
                let tran = Transactions(transactionID: jsonDict["transactionID"]!, employeeID: jsonDict["employeeID"]!, customerID: jsonDict["customerID"]!, productID: jsonDict["productID"]!, dateAndTime: jsonDict["dateAndTime"]!, subTotal: jsonDict["subTotal"]!, tax: jsonDict["tax"]!, total: jsonDict["total"]!)
